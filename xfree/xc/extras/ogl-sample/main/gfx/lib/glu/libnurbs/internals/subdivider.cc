 ...
 * subdivider.cxx
 *
 * $Date: 2001/06/09 15:20:54 $ $Revision: 1.1.1.1 $
 * $Header: /cvsroot/xsrc/xfree/xc/extras/ogl-sample/main/gfx/lib/glu/libnurbs/internals/Attic/subdivider.cc,v 1.1.1.1 2001/06/09 15:20:54 tron Exp $
 */
