/* $XFree86: xc/programs/Xserver/hw/xfree86/common/xf86DefModes.c,v 1.11 2005/02/26 01:07:12 dawes Exp $ */
...
/* 1152x864 @ 60 Hz (VESA GTF) hsync: 53.7kHz */
	{MODEPREFIX("1152x864"),81620, 1152,1216,1336,1520,0, 864,865,868,895,0, V_NHSYNC | V_PVSYNC, MODESUFFIX},
	{MODEPREFIX("576x432"),40810, 576,608,668,760,0, 432,432,434,447,0, V_NHSYNC | V_PVSYNC | V_DBLSCAN, MODESUFFIX},
