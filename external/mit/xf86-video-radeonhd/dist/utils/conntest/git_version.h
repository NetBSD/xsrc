 ...
 * abs_repo_dir="/suse/lverhaegen/X/xf86-video-radeonhd/.git" (should be "/path/to/.git")
 * abs_srcdir="/suse/lverhaegen/X/xf86-video-radeonhd" (absolute top source dir "/path/to")
 * git_repo_dir=".git" (usually ".git" or "/path/to/.git")
 * PWD="/suse/lverhaegen/X/xf86-video-radeonhd"
 * srcdir="../.."
 * working_dir="/suse/lverhaegen/X/xf86-video-radeonhd/utils/conntest"
 */
