...
{
   if (((const uint32_t *) cl)[0] & 0xf000) fprintf(stderr, "XXX: Invalid field of Draw unpacked at word 0\n");
...
{
   if (((const uint32_t *) cl)[0] & 0xe00000) fprintf(stderr, "XXX: Invalid field of Multisample, Misc unpacked at word 0\n");
                         ...
                         const struct MALI_RENDERER_STATE * restrict values)
{
   ...
   cl[14] = __gen_uint(values->legacy_blend_shader, 0, 63);
   cl[15] = __gen_uint(values->legacy_blend_shader, 0, 63) >> 32;
}
                           ...
                           struct MALI_RENDERER_STATE * restrict values)
{
   ...
   if (((const uint32_t *) cl)[8] & 0xe00000) fprintf(stderr, "XXX: Invalid field of Renderer State unpacked at word 8\n");
   ...
   values->legacy_blend_shader = __gen_unpack_uint(cl, 448, 511);
}
...
MALI_RENDERER_STATE_print(FILE *fp, const struct MALI_RENDERER_STATE * values, unsigned indent)
{
   ...
   fprintf(fp, "%*sLegacy Blend Shader: 0x%" PRIx64 "\n", indent, "", values->legacy_blend_shader);
}
                                 ...
                                 const struct MALI_FRAMEBUFFER_PARAMETERS * restrict values)
{
   ...
   cl[ 0] = __gen_uint(values->width - 1, 0, 15) |
            __gen_uint(values->height - 1, 16, 31);
   cl[ 1] = __gen_uint(values->bound_min_x, 0, 15) |
            __gen_uint(values->bound_min_y, 16, 31);
   cl[ 2] = __gen_uint(values->bound_max_x, 0, 15) |
            __gen_uint(values->bound_max_y, 16, 31);
   cl[ 3] = __gen_uint(util_logbase2(values->sample_count), 0, 2) |
   ...
   cl[ 4] = __gen_uint(values->s_clear, 0, 7) |
   ...
   cl[ 5] = __gen_uint(fui(values->z_clear), 0, 32);
}


#define MALI_FRAMEBUFFER_PARAMETERS_LENGTH 24
struct mali_framebuffer_parameters_packed { uint32_t opaque[6]; };
static inline void
MALI_FRAMEBUFFER_PARAMETERS_unpack(const uint8_t * restrict cl,
                                   struct MALI_FRAMEBUFFER_PARAMETERS * restrict values)
{
   if (((const uint32_t *) cl)[3] & 0x800000) fprintf(stderr, "XXX: Invalid field of Framebuffer Parameters unpacked at word 3\n");
   if (((const uint32_t *) cl)[4] & 0x3fc0f800) fprintf(stderr, "XXX: Invalid field of Framebuffer Parameters unpacked at word 4\n");
   values->width = __gen_unpack_uint(cl, 0, 15) + 1;
   values->height = __gen_unpack_uint(cl, 16, 31) + 1;
   values->bound_min_x = __gen_unpack_uint(cl, 32, 47);
   values->bound_min_y = __gen_unpack_uint(cl, 48, 63);
   values->bound_max_x = __gen_unpack_uint(cl, 64, 79);
   values->bound_max_y = __gen_unpack_uint(cl, 80, 95);
   values->sample_count = 1U << __gen_unpack_uint(cl, 96, 98);
   values->sample_pattern = (enum mali_sample_pattern)__gen_unpack_uint(cl, 99, 101);
   values->tie_break_rule = (enum mali_tie_break_rule)__gen_unpack_uint(cl, 102, 104);
   values->effective_tile_size = 1U << __gen_unpack_uint(cl, 105, 108);
   values->x_downsampling_scale = __gen_unpack_uint(cl, 109, 111);
   values->y_downsampling_scale = __gen_unpack_uint(cl, 112, 114);
   values->render_target_count = __gen_unpack_uint(cl, 115, 118) + 1;
   values->color_buffer_allocation = __gen_unpack_uint(cl, 120, 127) << 10;
   values->s_clear = __gen_unpack_uint(cl, 128, 135);
   values->s_write_enable = __gen_unpack_uint(cl, 136, 136);
   values->s_preload_enable = __gen_unpack_uint(cl, 137, 137);
   values->s_unload_enable = __gen_unpack_uint(cl, 138, 138);
   values->z_internal_format = (enum mali_z_internal_format)__gen_unpack_uint(cl, 144, 145);
   values->z_write_enable = __gen_unpack_uint(cl, 146, 146);
   values->z_preload_enable = __gen_unpack_uint(cl, 147, 147);
   values->z_unload_enable = __gen_unpack_uint(cl, 148, 148);
   values->has_zs_crc_extension = __gen_unpack_uint(cl, 149, 149);
   values->crc_read_enable = __gen_unpack_uint(cl, 158, 158);
   values->crc_write_enable = __gen_unpack_uint(cl, 159, 159);
   values->z_clear = __gen_unpack_float(cl, 160, 191);
}
...
struct MALI_ZS_CRC_EXTENSION {
   ...
   enum mali_zs_preload_format          zs_preload_format;
   ...
   uint32_t                             zs_afbc_chunk_size;
   bool                                 zs_afbc_sparse;
   uint64_t                             zs_afbc_body;
   uint32_t                             zs_afbc_body_size;
   uint64_t                             zs_preload_base;
   uint32_t                             zs_preload_row_stride;
   uint32_t                             zs_preload_surface_stride;
};
                           ...
                           const struct MALI_ZS_CRC_EXTENSION * restrict values)
{
   ...
   cl[ 3] = __gen_uint(values->zs_write_format, 0, 3) |
            ...
            __gen_uint(values->zs_preload_format, 28, 31);
   ...
   cl[ 7] = __gen_uint(values->zs_writeback_surface_stride, 0, 31) |
            __gen_uint(values->zs_afbc_chunk_size, 0, 11) |
            __gen_uint(values->zs_afbc_sparse, 16, 16);
   ...
   cl[10] = __gen_uint(values->s_writeback_row_stride, 0, 31) |
            __gen_uint(values->zs_afbc_body_size, 0, 31);
   cl[11] = __gen_uint(values->s_writeback_surface_stride, 0, 31);
   cl[12] = __gen_uint(values->zs_preload_base, 0, 63);
   cl[13] = __gen_uint(values->zs_preload_base, 0, 63) >> 32;
   cl[14] = __gen_uint(values->zs_preload_row_stride, 0, 31);
   cl[15] = __gen_uint(values->zs_preload_surface_stride, 0, 31);
}
...
{
   if (((const uint32_t *) cl)[3] & 0xf00fa00) fprintf(stderr, "XXX: Invalid field of ZS CRC Extension unpacked at word 3\n");
   ...
   values->zs_preload_format = (enum mali_zs_preload_format)__gen_unpack_uint(cl, 124, 127);
   ...
   values->zs_afbc_chunk_size = __gen_unpack_uint(cl, 224, 235);
   values->zs_afbc_sparse = __gen_unpack_uint(cl, 240, 240);
   values->zs_afbc_body = __gen_unpack_uint(cl, 256, 319);
   values->zs_afbc_body_size = __gen_unpack_uint(cl, 320, 351);
   values->zs_preload_base = __gen_unpack_uint(cl, 384, 447);
   values->zs_preload_row_stride = __gen_unpack_uint(cl, 448, 479);
   values->zs_preload_surface_stride = __gen_unpack_uint(cl, 480, 511);
}
...
struct MALI_RENDER_TARGET_YUV_OVERLAY {
   uint32_t                             conv_k5;
   enum mali_yuv_conv_k6                conv_k6;
   enum mali_yuv_conv_k7_clamp          conv_k7_clamp;
   enum mali_yuv_conv_k8                conv_k8;
   bool                                 conv_disable;
   uint32_t                             conv_k1;
   uint32_t                             conv_k2;
   uint32_t                             conv_k3;
                                    ...
                                    const struct MALI_RENDER_TARGET_YUV_OVERLAY * restrict values)
{
   cl[ 0] = 0;
   cl[ 1] = 0;
   cl[ 2] = __gen_uint(values->conv_k5, 16, 23) |
            __gen_uint(values->conv_k6, 24, 24) |
            __gen_uint(values->conv_k7_clamp, 25, 26) |
            __gen_uint(values->conv_k8, 27, 27) |
            __gen_uint(values->conv_disable, 31, 31);
   cl[ 3] = __gen_uint(values->conv_k1, 0, 7) |
            __gen_uint(values->conv_k2, 8, 15) |
            __gen_uint(values->conv_k3, 16, 23) |
            __gen_uint(values->conv_k4, 24, 31);
                                      ...
                                      struct MALI_RENDER_TARGET_YUV_OVERLAY * restrict values)
{
   ...
   if (((const uint32_t *) cl)[2] & 0x7000ffff) fprintf(stderr, "XXX: Invalid field of Render Target YUV Overlay unpacked at word 2\n");
   ...
   values->conv_k5 = __gen_unpack_uint(cl, 80, 87);
   values->conv_k6 = (enum mali_yuv_conv_k6)__gen_unpack_uint(cl, 88, 88);
   values->conv_k7_clamp = (enum mali_yuv_conv_k7_clamp)__gen_unpack_uint(cl, 89, 90);
   values->conv_k8 = (enum mali_yuv_conv_k8)__gen_unpack_uint(cl, 91, 91);
   values->conv_disable = __gen_unpack_uint(cl, 95, 95);
   values->conv_k1 = __gen_unpack_uint(cl, 96, 103);
   values->conv_k2 = __gen_unpack_uint(cl, 104, 111);
   values->conv_k3 = __gen_unpack_uint(cl, 112, 119);
   values->conv_k4 = __gen_unpack_uint(cl, 120, 127);
                                     ...
                                     const struct MALI_RENDER_TARGET_AFBC_OVERLAY * restrict values)
{
   ...
   cl[ 7] = __gen_uint(values->chunk_size, 0, 11) |
            __gen_uint(values->sparse, 16, 16) |
                                       ...
                                       struct MALI_RENDER_TARGET_AFBC_OVERLAY * restrict values)
{
   ...
   if (((const uint32_t *) cl)[7] & 0xfffcf000) fprintf(stderr, "XXX: Invalid field of Render Target AFBC Overlay unpacked at word 7\n");
   ...
   values->sparse = __gen_unpack_uint(cl, 240, 240);
...
struct MALI_RENDER_TARGET {
   ...
   uint32_t                             swizzle;
   enum mali_downsampling_accumulation_mode writeback_sampling_mode;
   bool                                 clean_pixel_write_enable;
   bool                                 preload_enable;
   bool                                 unload_enable;
   enum mali_color_format               preload_format;
   enum mali_rt_endianness              preload_endianness;
   enum mali_block_format               preload_block_format;
   enum mali_msaa                       preload_msaa;
   struct MALI_RT_BUFFER                rgb;
   struct MALI_RT_BUFFER                preload_buffer;
...
#define MALI_RENDER_TARGET_header               \
   ...
   .preload_buffer = { MALI_RT_BUFFER_header },  \
                        ...
                        const struct MALI_RENDER_TARGET * restrict values)
{
   ...
   cl[ 1] = __gen_uint(values->write_enable, 0, 0) |
            ...
            __gen_uint(values->writeback_sampling_mode, 29, 30) |
            __gen_uint(values->clean_pixel_write_enable, 31, 31);
   cl[ 2] = __gen_uint(values->yuv.conv_k5, 16, 23) |
            __gen_uint(values->yuv.conv_k6, 24, 24) |
            __gen_uint(values->yuv.conv_k7_clamp, 25, 26) |
            __gen_uint(values->yuv.conv_k8, 27, 27) |
            __gen_uint(values->yuv.conv_disable, 31, 31) |
            __gen_uint(values->preload_enable, 0, 0) |
            __gen_uint(values->unload_enable, 1, 1) |
            __gen_uint(values->preload_format, 3, 7) |
            __gen_uint(values->preload_endianness, 8, 9) |
            __gen_uint(values->preload_block_format, 10, 13) |
            __gen_uint(values->preload_msaa, 14, 15);
   cl[ 3] = __gen_uint(values->yuv.conv_k1, 0, 7) |
            __gen_uint(values->yuv.conv_k2, 8, 15) |
            __gen_uint(values->yuv.conv_k3, 16, 23) |
            __gen_uint(values->yuv.conv_k4, 24, 31);
   ...
   cl[ 7] = __gen_uint(values->yuv.plane_1_base, 0, 63) >> 32 |
            ...
            __gen_uint(values->afbc.sparse, 16, 16) |
   ...
   cl[12] = __gen_uint(values->preload_buffer.base, 0, 63) |
            __gen_uint(values->clear.color_0, 0, 31);
   cl[13] = __gen_uint(values->preload_buffer.base, 0, 63) >> 32 |
            __gen_uint(values->clear.color_1, 0, 31);
   cl[14] = __gen_uint(values->preload_buffer.row_stride, 0, 31) |
            __gen_uint(values->clear.color_2, 0, 31);
   cl[15] = __gen_uint(values->preload_buffer.surface_stride, 0, 31) |
            __gen_uint(values->clear.color_3, 0, 31);
}
...
{
   if (((const uint32_t *) cl)[0] & 0x2ff000f) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 0\n");
   if (((const uint32_t *) cl)[1] & 0x10000006) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 1\n");
   if (((const uint32_t *) cl)[2] & 0x70000004) fprintf(stderr, "XXX: Invalid field of Render Target unpacked at word 2\n");
   values->yuv.conv_k5 = __gen_unpack_uint(cl, 80, 87);
   values->yuv.conv_k6 = (enum mali_yuv_conv_k6)__gen_unpack_uint(cl, 88, 88);
   values->yuv.conv_k7_clamp = (enum mali_yuv_conv_k7_clamp)__gen_unpack_uint(cl, 89, 90);
   values->yuv.conv_k8 = (enum mali_yuv_conv_k8)__gen_unpack_uint(cl, 91, 91);
   values->yuv.conv_disable = __gen_unpack_uint(cl, 95, 95);
   values->yuv.conv_k1 = __gen_unpack_uint(cl, 96, 103);
   values->yuv.conv_k2 = __gen_unpack_uint(cl, 104, 111);
   values->yuv.conv_k3 = __gen_unpack_uint(cl, 112, 119);
   values->yuv.conv_k4 = __gen_unpack_uint(cl, 120, 127);
   ...
   values->afbc.sparse = __gen_unpack_uint(cl, 240, 240);
   ...
   values->writeback_sampling_mode = (enum mali_downsampling_accumulation_mode)__gen_unpack_uint(cl, 61, 62);
   values->clean_pixel_write_enable = __gen_unpack_uint(cl, 63, 63);
   values->preload_enable = __gen_unpack_uint(cl, 64, 64);
   values->unload_enable = __gen_unpack_uint(cl, 65, 65);
   values->preload_format = (enum mali_color_format)__gen_unpack_uint(cl, 67, 71);
   values->preload_endianness = (enum mali_rt_endianness)__gen_unpack_uint(cl, 72, 73);
   values->preload_block_format = (enum mali_block_format)__gen_unpack_uint(cl, 74, 77);
   values->preload_msaa = (enum mali_msaa)__gen_unpack_uint(cl, 78, 79);
   ...
   values->preload_buffer.base = __gen_unpack_uint(cl, 384, 447);
   values->preload_buffer.row_stride = __gen_unpack_uint(cl, 448, 479);
   values->preload_buffer.surface_stride = __gen_unpack_uint(cl, 480, 511);
...
#define MALI_FRAMEBUFFER_SECTION_TILER_OFFSET 56
...
#define MALI_FRAMEBUFFER_SECTION_TILER_WEIGHTS_OFFSET 96
