...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_828)(GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize, GLint *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_871)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_872)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_873)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_874)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_875)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_876)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_877)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_878)(const GLfixed *coords);
GLAPI void APIENTRY GLAPI_PREFIX(PointSizePointerOES)(GLenum type, GLsizei stride, const GLvoid *pointer);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_880)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_881)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_882)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_889)(GLenum target, GLsizei numAttachments, const GLenum *attachments);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_890)(GLuint pipeline, GLuint program);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_891)(GLuint pipeline);
GLuint APIENTRY GLAPI_PREFIX(_dispatch_stub_892)(GLenum type, GLsizei count, const GLchar * const *strings);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_893)(GLsizei n, const GLuint *pipelines);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_894)(GLsizei n, GLuint *pipelines);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_895)(GLuint pipeline, GLsizei bufSize, GLsizei *length, GLchar *infoLog);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_896)(GLuint pipeline, GLenum pname, GLint *params);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_897)(GLuint pipeline);
GLAPI void APIENTRY GLAPI_PREFIX(LockArraysEXT)(GLint first, GLsizei count);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_899)(GLuint program, GLint location, GLfloat x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_900)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_901)(GLuint program, GLint location, GLint x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_902)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_903)(GLuint program, GLint location, GLuint x);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_904)(GLuint program, GLint location, GLsizei count, const GLuint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_905)(GLuint program, GLint location, GLfloat x, GLfloat y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_906)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_907)(GLuint program, GLint location, GLint x, GLint y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_908)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_909)(GLuint program, GLint location, GLuint x, GLuint y);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_910)(GLuint program, GLint location, GLsizei count, const GLuint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_911)(GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_912)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_913)(GLuint program, GLint location, GLint x, GLint y, GLint z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_914)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_915)(GLuint program, GLint location, GLuint x, GLuint y, GLuint z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_916)(GLuint program, GLint location, GLsizei count, const GLuint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_917)(GLuint program, GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_918)(GLuint program, GLint location, GLsizei count, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_919)(GLuint program, GLint location, GLint x, GLint y, GLint z, GLint w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_920)(GLuint program, GLint location, GLsizei count, const GLint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_921)(GLuint program, GLint location, GLuint x, GLuint y, GLuint z, GLuint w);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_922)(GLuint program, GLint location, GLsizei count, const GLuint *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_923)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_924)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_925)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_926)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_927)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_928)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_929)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_930)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_931)(GLuint program, GLint location, GLsizei count, GLboolean transpose, const GLfloat *value);
GLAPI void APIENTRY GLAPI_PREFIX(UnlockArraysEXT)(void);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_933)(GLuint pipeline, GLbitfield stages, GLuint program);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_934)(GLuint pipeline);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_959)(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_960)(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1034)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1035)(GLuint array);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1036)(GLsizei n, GLuint *arrays);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1044)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1045)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1046)(GLenum coord, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1047)(GLclampd zmin, GLclampd zmax);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1050)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1051)(GLenum target, GLintptr offset, GLsizeiptr size);
...
GLAPI void APIENTRY GLAPI_PREFIX(BeginPerfMonitorAMD)(GLuint monitor);
GLAPI void APIENTRY GLAPI_PREFIX(DeletePerfMonitorsAMD)(GLsizei n, GLuint *monitors);
GLAPI void APIENTRY GLAPI_PREFIX(EndPerfMonitorAMD)(GLuint monitor);
GLAPI void APIENTRY GLAPI_PREFIX(GenPerfMonitorsAMD)(GLsizei n, GLuint *monitors);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorCounterDataAMD)(GLuint monitor, GLenum pname, GLsizei dataSize, GLuint *data, GLint *bytesWritten);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorCounterInfoAMD)(GLuint group, GLuint counter, GLenum pname, GLvoid *data);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorCounterStringAMD)(GLuint group, GLuint counter, GLsizei bufSize, GLsizei *length, GLchar *counterString);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorCountersAMD)(GLuint group, GLint *numCounters, GLint *maxActiveCounters, GLsizei countersSize, GLuint *counters);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorGroupStringAMD)(GLuint group, GLsizei bufSize, GLsizei *length, GLchar *groupString);
GLAPI void APIENTRY GLAPI_PREFIX(GetPerfMonitorGroupsAMD)(GLint *numGroups, GLsizei groupsSize, GLuint *groups);
GLAPI void APIENTRY GLAPI_PREFIX(SelectPerfMonitorCountersAMD)(GLuint monitor, GLboolean enable, GLuint group, GLint numCounters, GLuint *counterList);
...
GLAPI void APIENTRY GLAPI_PREFIX(TextureBarrier)(void);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUFiniNV)(void);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUGetSurfaceivNV)(GLintptr surface, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUInitNV)(const GLvoid *vdpDevice, const GLvoid *getProcAddress);
GLAPI GLboolean APIENTRY GLAPI_PREFIX(VDPAUIsSurfaceNV)(GLintptr surface);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUMapSurfacesNV)(GLsizei numSurfaces, const GLintptr *surfaces);
GLAPI GLintptr APIENTRY GLAPI_PREFIX(VDPAURegisterOutputSurfaceNV)(const GLvoid *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);
GLAPI GLintptr APIENTRY GLAPI_PREFIX(VDPAURegisterVideoSurfaceNV)(const GLvoid *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUSurfaceAccessNV)(GLintptr surface, GLenum access);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUUnmapSurfacesNV)(GLsizei numSurfaces, const GLintptr *surfaces);
GLAPI void APIENTRY GLAPI_PREFIX(VDPAUUnregisterSurfaceNV)(GLintptr surface);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1097)(GLuint queryHandle);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1098)(GLuint queryId, GLuint *queryHandle);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1099)(GLuint queryHandle);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1100)(GLuint queryHandle);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1101)(GLuint *queryId);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1102)(GLuint queryId, GLuint *nextQueryId);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1103)(GLuint queryId, GLuint counterId, GLuint counterNameLength, GLchar *counterName, GLuint counterDescLength, GLchar *counterDesc, GLuint *counterOffset, GLuint *counterDataSize, GLuint *counterTypeEnum, GLuint *counterDataTypeEnum, GLuint64 *rawCounterMaxValue);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1104)(GLuint queryHandle, GLuint flags, GLsizei dataSize, GLvoid *data, GLuint *bytesWritten);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1105)(GLchar *queryName, GLuint *queryId);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1106)(GLuint queryId, GLuint queryNameLength, GLchar *queryName, GLuint *dataSize, GLuint *noCounters, GLuint *noInstances, GLuint *capsMask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1107)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1108)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1109)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
...
STUB_ASM_ENTRY(GLAPI_PREFIX_STR(MinSampleShading))"\n"
"\t"STUB_ASM_CODE("620")"\n"
...
STUB_ASM_ENTRY(GLAPI_PREFIX_STR(BeginPerfMonitorAMD))"\n"
"\t"STUB_ASM_CODE("1069")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(DeletePerfMonitorsAMD))"\n"
"\t"STUB_ASM_CODE("1070")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(EndPerfMonitorAMD))"\n"
"\t"STUB_ASM_CODE("1071")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GenPerfMonitorsAMD))"\n"
"\t"STUB_ASM_CODE("1072")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorCounterDataAMD))"\n"
"\t"STUB_ASM_CODE("1073")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorCounterInfoAMD))"\n"
"\t"STUB_ASM_CODE("1074")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorCounterStringAMD))"\n"
"\t"STUB_ASM_CODE("1075")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorCountersAMD))"\n"
"\t"STUB_ASM_CODE("1076")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorGroupStringAMD))"\n"
"\t"STUB_ASM_CODE("1077")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(GetPerfMonitorGroupsAMD))"\n"
"\t"STUB_ASM_CODE("1078")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(SelectPerfMonitorCountersAMD))"\n"
"\t"STUB_ASM_CODE("1079")"\n"
...
".globl "GLAPI_PREFIX_STR(TextureBarrier)"\n"
".set "GLAPI_PREFIX_STR(TextureBarrier)", "GLAPI_PREFIX_STR(TextureBarrierNV)"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUFiniNV))"\n"
"\t"STUB_ASM_CODE("1087")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUGetSurfaceivNV))"\n"
"\t"STUB_ASM_CODE("1088")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUInitNV))"\n"
"\t"STUB_ASM_CODE("1089")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUIsSurfaceNV))"\n"
"\t"STUB_ASM_CODE("1090")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUMapSurfacesNV))"\n"
"\t"STUB_ASM_CODE("1091")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAURegisterOutputSurfaceNV))"\n"
"\t"STUB_ASM_CODE("1092")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAURegisterVideoSurfaceNV))"\n"
"\t"STUB_ASM_CODE("1093")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUSurfaceAccessNV))"\n"
"\t"STUB_ASM_CODE("1094")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUUnmapSurfacesNV))"\n"
"\t"STUB_ASM_CODE("1095")"\n"

STUB_ASM_ENTRY(GLAPI_PREFIX_STR(VDPAUUnregisterSurfaceNV))"\n"
"\t"STUB_ASM_CODE("1096")"\n"
