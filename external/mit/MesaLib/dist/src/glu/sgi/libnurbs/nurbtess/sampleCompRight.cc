...
**
** $Date: 2008/07/29 05:10:40 $ $Revision: 1.1.1.1 $
*/
/*
** $Header: /cvsroot/xsrc/external/mit/MesaLib/dist/src/glu/sgi/libnurbs/nurbtess/Attic/sampleCompRight.cc,v 1.1.1.1 2008/07/29 05:10:40 mrg Exp $
*/
