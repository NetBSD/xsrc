...
**
** $Date: 2008/07/29 05:10:34 $ $Revision: 1.1.1.1 $
*/
/*
** $Header: /cvsroot/xsrc/external/mit/MesaLib/dist/src/glu/sgi/libnurbs/interface/Attic/bezierPatchMesh.cc,v 1.1.1.1 2008/07/29 05:10:34 mrg Exp $
*/
