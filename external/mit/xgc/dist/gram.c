...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_FUNCTIONTYPE = 7,               /* FUNCTIONTYPE  */
  YYSYMBOL_TEST = 8,                       /* TEST  */
  YYSYMBOL_TESTTYPE = 9,                   /* TESTTYPE  */
  YYSYMBOL_LINESTYLE = 10,                 /* LINESTYLE  */
  YYSYMBOL_LINESTYLETYPE = 11,             /* LINESTYLETYPE  */
  YYSYMBOL_CAPSTYLE = 12,                  /* CAPSTYLE  */
  YYSYMBOL_CAPSTYLETYPE = 13,              /* CAPSTYLETYPE  */
  YYSYMBOL_JOINSTYLE = 14,                 /* JOINSTYLE  */
  YYSYMBOL_JOINSTYLETYPE = 15,             /* JOINSTYLETYPE  */
  YYSYMBOL_ROUND = 16,                     /* ROUND  */
  YYSYMBOL_SOLID = 17,                     /* SOLID  */
  YYSYMBOL_FILLSTYLE = 18,                 /* FILLSTYLE  */
  YYSYMBOL_FILLSTYLETYPE = 19,             /* FILLSTYLETYPE  */
  YYSYMBOL_FILLRULE = 20,                  /* FILLRULE  */
  YYSYMBOL_FILLRULETYPE = 21,              /* FILLRULETYPE  */
  YYSYMBOL_ARCMODE = 22,                   /* ARCMODE  */
  YYSYMBOL_ARCMODETYPE = 23,               /* ARCMODETYPE  */
  YYSYMBOL_FOREGROUND = 24,                /* FOREGROUND  */
  YYSYMBOL_BACKGROUND = 25,                /* BACKGROUND  */
  YYSYMBOL_LINEWIDTH = 26,                 /* LINEWIDTH  */
  YYSYMBOL_PLANEMASK = 27,                 /* PLANEMASK  */
  YYSYMBOL_DASHLIST = 28,                  /* DASHLIST  */
...
static const char *const yytname[] =
{
  ...
  "RUN", "FUNCTION", "FUNCTIONTYPE", "TEST", "TESTTYPE", "LINESTYLE",
  "LINESTYLETYPE", "CAPSTYLE", "CAPSTYLETYPE", "JOINSTYLE",
  "JOINSTYLETYPE", "ROUND", "SOLID", "FILLSTYLE", "FILLSTYLETYPE",
  "FILLRULE", "FILLRULETYPE", "ARCMODE", "ARCMODETYPE", "FOREGROUND",
  "BACKGROUND", "LINEWIDTH", "PLANEMASK", "DASHLIST", "PERCENT", "FONT",
  "'\\n'", "$accept", "all", "stmts", "stmt", YY_NULLPTR
};
