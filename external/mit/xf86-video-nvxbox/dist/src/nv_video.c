...
#ifndef XvExtension
void NVXInitVideo(ScreenPtr pScreen) {}
#else
...
static XF86VideoFormatRec NVFormats[NUM_FORMATS_ALL] = 
{
...
static XF86AttributeRec NVAttributes[NUM_ATTRIBUTES] =
{
...
void NVXInitVideo (ScreenPtr pScreen)
{
    ...
    DEBUG(xf86DrvMsg(pScrn->scrnIndex, X_INFO, "NVXInitVideo\n"));
...
static XF86OffscreenImageRec NVOffscreenImages[2] =
{
 {
   &NVImages[0],
