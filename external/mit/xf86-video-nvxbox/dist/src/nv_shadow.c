...
void
NVXRefreshArea(ScrnInfoPtr pScrn, int num, BoxPtr pbox)
{
...
void
NVXPointerMoved(int index, int x, int y)
{
...
void
NVXRefreshArea8(ScrnInfoPtr pScrn, int num, BoxPtr pbox)
{
    NVPtr pNv = NVPTR(pScrn);
...
void
NVXRefreshArea16(ScrnInfoPtr pScrn, int num, BoxPtr pbox)
{
    NVPtr pNv = NVPTR(pScrn);
    int count, width, height, y1, y2, dstPitch, srcPitch;
...
void
NVXRefreshArea32(ScrnInfoPtr pScrn, int num, BoxPtr pbox)
{
    NVPtr pNv = NVPTR(pScrn);
