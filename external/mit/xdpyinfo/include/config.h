...
/* Define to 1 if you have the <X11/extensions/xf86dgaproto.h> header file. */
#define HAVE_X11_EXTENSIONS_XF86DGAPROTO_H 1

/* Define to 1 if you have the <X11/extensions/xf86dgastr.h> header file. */
#define HAVE_X11_EXTENSIONS_XF86DGASTR_H 1
