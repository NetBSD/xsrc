...
**
** $Date: 2006/04/22 15:22:55 $ $Revision: 1.1.1.1 $
*/
/*
** $Header: /cvsroot/xsrc/dist/Mesa/src/glu/sgi/libnurbs/internals/Attic/monoTriangulationBackend.cc,v 1.1.1.1 2006/04/22 15:22:55 macallan Exp $
*/
