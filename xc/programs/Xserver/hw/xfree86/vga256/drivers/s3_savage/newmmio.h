...
/*#define s3vMmioMem              (s3Priv.MmioMem)*/
#define s3vMmioMem s3savMmioMem
...
#define STATUS_WORD0            (*(volatile unsigned int*)(((char*)s3vMmioMem) + 0x48C00))
/* Savage4 Rev B only: */
#define ALT_STATUS_WORD0        (*(volatile unsigned int*)(((char*)s3vMmioMem) + 0x48C60))
