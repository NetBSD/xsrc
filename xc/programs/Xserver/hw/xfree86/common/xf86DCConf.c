/* $XFree86: xc/programs/Xserver/hw/xfree86/common/xf86DCConf.c,v 3.2.2.2 1999/07/23 13:22:42 hohndel Exp $ */
  ...
  do{
	...
	do {  /* get next token */
	  if (!c)  {
	    ...
	    if(* currpointer == (char) EOF){       /* handle EOF */ 
	      xfree(configRBuf);
	      pos = 0;
