/* $XFree86: xc/programs/Xserver/hw/xfree86/common/xf86Kbd.c,v 3.14.2.4 1999/07/29 09:22:47 hohndel Exp $ */
/*
...
{
  KeySym        *k;
#if !defined(Lynx) && !defined(AMOEBA) && !defined(MINIX) && !defined(__OSF__) && !defined(__EMX__) && !defined(__mips__) && !defined(DGUX) && !defined(__GNU__) && !defined(__QNX__) && !defined(__QNXNTO__)
  keymap_t      keymap;
...
#if !defined(Lynx) && !defined(AMOEBA) && !defined(MINIX) && !defined(__OSF__) && !defined(__EMX__) && !defined(__mips__) && !defined(__GNU__) && !defined(__QNX__) && !defined(__QNXNTO__)
  xf86Info.kbdType =
