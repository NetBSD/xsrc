/* $XFree86: xc/programs/Xserver/hw/xfree86/accel/mach8/mach8text.c,v 3.6 1996/10/10 14:02:25 dawes Exp $ */
/*
 ...
 * Modified for Mach8, Hans Nasten. (nasten@everyware.se)
 */
/* $XConsortium: mach8text.c /main/4 1995/11/12 18:01:08 kaleb $ */
...
extern unsigned short mach8stipple_tab[];
...
int mach8NoCPolyText(pDraw, pGC, x, y, count, chars, is8bit)
     DrawablePtr pDraw;
     GCPtr pGC;
     int   x;
     int   y;
...
int mach8NoCImageText(pDraw, pGC, x, y, count, chars, is8bit)
     DrawablePtr pDraw;
     GCPtr pGC;
     int   x;
     int   y;
